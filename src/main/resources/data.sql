...
-- =========================
-- USERS (1 Admin, 1 Reception, 3 Trainers, 10 Members)
...
-- PACKAGES
-- =========================
INSERT IGNORE INTO packages (package_id, package_name, price, duration_months, status, created_at, updated_at) VALUES
(1, 'Gói Cơ Bản (Standard)', 600000, 1, 1, NOW(), NOW()),
(2, 'Gói Tiết Kiệm (Saver)', 3200000, 6, 1, NOW(), NOW()),
(3, 'Hội Viên VIP (Elite)', 5500000, 12, 1, NOW(), NOW()),
(4, 'Thẻ Platinum (All-in-one)', 12000000, 12, 1, NOW(), NOW());

-- =========================
-- SERVICES (Nội dung thực tế thu hút)
-- =========================
INSERT IGNORE INTO services (service_id, service_name, price, status, created_at, updated_at) VALUES
(1, 'Yoga Trị Liệu & Thiền', 250000, 1, NOW(), NOW()),
(2, 'Boxing & Kickboxing', 300000, 1, NOW(), NOW()),
(3, 'Zumba & Aerobics', 200000, 1, NOW(), NOW()),
(4, 'Huấn Luyện Viên Cá Nhân (PT)', 500000, 1, NOW(), NOW());
...
-- =========================
-- NEWS (4 Bài viết ở 4 thể loại thực tế)
-- =========================
...
-- =========================
-- TRIAL REQUEST (3 Bản ghi tập thử)
-- =========================
