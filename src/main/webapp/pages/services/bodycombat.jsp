...
<head>
    ...
    <title>BODY COMBAT - CODEGYM</title>
...
<main class="zumba-page">
    ...
    <section class="zumba-banner">
        ...
        <div class="zumba-banner-content">
            <p class="zumba-breadcrumb"><a href="${pageContext.request.contextPath}/pages/services.jsp" style="color: inherit; text-decoration: none;">DỊCH VỤ</a> &gt; BODY COMBAT</p>
            <h1 class="zumba-banner-title">BODY COMBAT</h1>
        </div>
    </section>
    ...
    <section class="zumba-intro">
        <div class="zumba-intro-text">
            <h2 class="section-title">BODY COMBAT</h2>
            <p class="section-description">
                BODYCOMBAT là hình thức luyện tập đầy năng lượng, lấy cảm hứng từ võ thuật. Bạn sẽ thực hiện những cú đấm và đá để phát triển thể lực và sức mạnh của mình.
            </p>
        </div>
    ...
    <section class="zumba-benefits-section">
        <div class="zumba-benefits-header">
            ...
            <p class="zumba-benefits-description">
                Lớp Body Pump là phương pháp tập luyện với tạ theo 1 nhóm. Sự
                kết hợp hoàn toàn mới lạ và độc đáo giữa nâng tạ và âm nhạc sẽ
                mang lại hiệu quả tăng cơ nhanh chóng và đốt mỡ toàn thân.
            </p>
        </div>
        ...
        <div class="zumba-benefits-grid">
            ...
            <article class="benefit-card">
                ...
                <p>
                    Việc luân chuyển giữa các tư thế võ thuật đòi hỏi sự co giãn cơ liên tục, giúp
                    tăng phạm vi chuyển động và sự linh hoạt tối đa cho các khớp xương.
                </p>
            </article>
            ...
            <article class="benefit-card">
                ...
                <p>
                    Rèn luyện khả năng trụ vững qua các thế tấn và kỹ thuật đá, giúp cơ thể đạt được
                    sự thăng bằng tuyệt đối và cải thiện tư thế đứng vững vàng.                </p>
            </article>
            ...
            <article class="benefit-card">
                ...
                <p>
                    Với cường độ Cardio cao, BodyCombat giúp tim mạch hoạt động mạnh mẽ, rèn luyện
                    ý chí kiên cường và sức chịu đựng dẻo dai trong mọi thử thách.
                </p>
            </article>
        </div>
    </section>
