                    ...
                    <main class="services-page page-transition-main">
                        ...
                        <section class="services-intro">
                            ...
                            <p class="section-description">
                                Các chương trình luyện tập được thiết kế một cách khoa học và phù hợp bởi các chuyên
                                gia, sẽ hỗ trợ bạn
                        ...
                        <section class="services-list">
                            <c:choose>
                                            ...
                                            <article class="service-card">
                                                <c:choose>
                                                    <c:when test="${empty service.image}">
                                                        <img src="${pageContext.request.contextPath}/uploads/banner-tin-tuc-8.png"
                                                             alt="${service.serviceName}" class="service-card-image">
                                                    </c:when>
                                                    <c:otherwise>
                                                ...
                                                <div class="service-card-content">
                                                    ...
                                                    <div class="service-card-meta">
                                                        <c:choose>
                                                            <c:when
                                                                test="${service.price != null && service.price > 0}">
                                                    ...
                                                    <p class="service-card-description">
                                                        <c:set var="words" value="${fn:split(service.description, ' ')}" />
                                                        <c:choose>
                                ...
                                <c:otherwise>
                                    <div
                                        style="text-align: center; font-size: 18px; color: #555; grid-column: 1 / -1; padding: 40px;">
