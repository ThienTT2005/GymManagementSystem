...
<main class="zumba-page page-transition-main">
    <section class="zumba-banner">
        ...
        <div class="zumba-banner-content">
            <p class="zumba-breadcrumb">
                <a href="${pageContext.request.contextPath}/services"
                   style="color: inherit; text-decoration: none;">DỊCH VỤ</a>
                &gt;
                <c:out value="${fn:toUpperCase(service.serviceName)}" />
            </p>

            <h1 class="zumba-banner-title">
                <c:out value="${fn:toUpperCase(service.serviceName)}" />
            </h1>
        </div>
    </section>
    ...
    <section class="zumba-benefits-section">
        ...
        <div class="zumba-benefits-grid">
            <article class="benefit-card">
                <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#2dd4bf"
                     stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
