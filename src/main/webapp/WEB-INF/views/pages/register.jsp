...
<head>
    ...
    <title>Gym Pro - Đăng ký tập thử</title>
...
<div class="container">
    ...
    <section class="intro-section">
        <div class="intro-content">
            <h2 class="section-title">ĐẾN GYM PRO, TẬP LUYỆN<br>ĐA DẠNG BỘ MÔN</h2>
            <div class="divider"></div>
            <p style="font-size: 30px; margin-top: 40px;">
                Tại GYM PRO, chúng tôi mang đến hệ thống tập luyện đẳng cấp với các bộ môn từ nhảy hiện đại, võ thuật tự vệ đến các bài tập cân bằng thân tâm. Dù mục tiêu của bạn là giảm cân, tăng cơ hay giải tỏa căng thẳng, chúng tôi luôn có lộ trình phù hợp dành riêng cho bạn.
            </p>
        </div>
    ...
    <section class="location-section">
        ...
        <div class="location-content">
            ...
            <div class="divider"></div>
            <p style="font-size: 30px; margin-top: 40px;">
                GYM PRO tự hào sở hữu không gian tập luyện với thiết kế hiện đại, tối ưu hóa diện tích và ánh sáng.
