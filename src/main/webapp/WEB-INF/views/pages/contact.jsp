...
<script>
    ...
    contactForm.addEventListener("submit", function (e) {
        ...
        if (contactForm.checkValidity()) {
            ...
            fetch("${pageContext.request.contextPath}/api/consultations", {
                method: "POST",
                headers: {
            ...
            .then(response => {
                if (response.ok) {
                    successMessage.innerText = "Chúng tôi đã nhận được yêu cầu của bạn và sẽ phản hồi sớm nhất.";
            ...
            .catch(error => {
                successMessage.innerText = error.message || "Có lỗi xảy ra, vui lòng thử lại sau.";
