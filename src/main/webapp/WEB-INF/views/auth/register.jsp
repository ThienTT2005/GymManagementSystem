...
<head>
    ...
    <script>
        ...
        window.onload = function() {
            document.querySelectorAll("input").forEach(i => i.value = i.value || "");
        };
    </script>
</head>
...
<div class="box">
    ...
    <form action="${pageContext.request.contextPath}/register" method="post" onsubmit="return validateForm()">
        <input type="text" name="fullName" placeholder="Họ tên" value="${param.fullName}" autocomplete="off">
        <input type="text" name="username" placeholder="Username" value="${param.username}" autocomplete="off">
