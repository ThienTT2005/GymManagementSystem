    ...
    <div class="app-body">
        ...
        <div class="app-content">
            <div class="page-topbar">
                <h2 class="page-title">Tư vấn</h2>
            </div>

            <div class="list-card">
                <div class="list-toolbar">
                    <form method="get"
                          action="${pageContext.request.contextPath}/receptionist/consultation"
                          class="search-form">
                        <div class="search-box">
                            <i class="fa-solid fa-magnifying-glass"></i>
                            <input type="text" name="keyword" value="${keyword}" placeholder="Tìm theo tên hoặc số điện thoại">
                        </div>
                ...
                <div class="table-wrap">
                    <table class="member-table">
                        ...
                        <c:choose>
                            <c:when test="${not empty consultations}">
                                <c:forEach var="c" items="${consultations}">
                                    <tr>
                                        ...
                                        <td>
                                            <form method="post"
                                                  action="${pageContext.request.contextPath}/receptionist/consultation/toggle">
                                                <input type="hidden" name="id" value="${c.consultationId}">
                            ...
                            <c:otherwise>
                                <tr>
                                    <td colspan="6" class="empty-row">Chưa có dữ liệu tư vấn</td>
                                </tr>
                            </c:otherwise>
                        </c:choose>
                        </tbody>
