...
<div class="app-shell">
    ...
    <div class="app-body">
        ...
        <div class="app-content">
            <div class="page-card">
                <h2 class="page-title">Đăng ký gói tập</h2>
                ...
                <div class="form-card register-card">
                    ...
                    <form method="post"
                          ...
                          action="${pageContext.request.contextPath}/receptionist/register-package"
                          class="member-form">
                ...
                <div class="table-card" style="margin-top: 24px;">
                    <h3 class="form-title">Danh sách đăng ký gói tập</h3>
                    ...
                    <div class="table-wrap">
                        <table class="custom-table">
                            ...
                            <c:choose>
                                <c:when test="${not empty memberships}">
                                    <c:forEach var="item" items="${memberships}">
                                        <tr>
                                            ...
                                            <td>
                                                <c:choose>
                                                    <c:when test="${item.gymPackage != null}">
                                                        ${item.gymPackage.packageName}
                                                    </c:when>
                                                    <c:otherwise>-</c:otherwise>
                                                </c:choose>
                                            </td>
                                ...
                                <c:otherwise>
                                    <tr>
                                        <td colspan="7" style="text-align: center;">Chưa có đăng ký gói tập nào.</td>
                                    </tr>
                                </c:otherwise>
                            </c:choose>
                            </tbody>
