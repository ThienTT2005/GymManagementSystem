        ...
        <main class="app-content">
            <div class="page-header">
                <div>
                    ...
                    <p>Danh sách khách cần tư vấn</p>
                </div>
                <a class="btn-primary" href="${pageContext.request.contextPath}/admin/contacts/create">
            ...
            <div class="page-card">
                <form method="get" action="${pageContext.request.contextPath}/admin/contacts" class="filter-form">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn-sm btn-edit"
                                               href="${pageContext.request.contextPath}/admin/contacts/edit/${item.consultationId}">
                                                Sửa
                                            </a>

                                            <form method="post"
                                                  action="${pageContext.request.contextPath}/admin/contacts/delete/${item.consultationId}"
                                                  style="display:inline-block"
                                                  onsubmit="return confirm('Bạn có chắc muốn hủy đăng ký tư vấn này?');">
                ...
                <c:if test="${consultationPage.totalPages > 1}">
                    <div class="pagination">
                        <c:forEach begin="0" end="${consultationPage.totalPages - 1}" var="p">
                            <a class="${p + 1 == consultationPage.number + 1 ? 'active' : ''}"
                               href="${pageContext.request.contextPath}/admin/contacts?keyword=${keyword}&status=${status}&page=${p + 1}&size=${consultationPage.size}">
                                ${p + 1}
                            </a>
                        </c:forEach>
                    </div>
