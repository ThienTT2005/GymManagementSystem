        ...
        <main class="app-content">
            ...
            <div class="page-header">
                ...
                <div class="table-actions">
                    ...
                    <a href="${pageContext.request.contextPath}/admin/members/edit/${member.memberId}" class="btn-primary">
                ...
                <div class="profile-left-card">
                    ...
                    <div class="profile-quick-info">
                        ...
                        <div class="profile-quick-item">
                            ...
                            <span>${member.user != null ? member.user.username : 'Chưa liên kết'}</span>
                        </div>

                    </div>

                    <!-- PACKAGE -->
                    <c:if test="${not empty member.currentPackageName}">
                        <div class="profile-specialty-box">
                            <strong>Gói hiện tại</strong>

                            <span>${member.currentPackageName}</span>

                            <span>
                                ${empty member.currentMembershipStatus ? 'Chưa cập nhật' : member.currentMembershipStatus}
                            </span>

                            <span>
                                ${empty member.currentMembershipEndDate ? 'Chưa cập nhật' : member.currentMembershipEndDate}
                            </span>
                        </div>
                    </c:if>
                ...
                <div class="profile-right-card">
                    ...
                    <div class="profile-detail-grid">
                        ...
                        <div class="profile-detail-item full-row">
                            ...
                            <c:choose>
                                <c:when test="${not empty currentRegistrations}">
                                    <div class="profile-list-block">
                                        <c:forEach var="r" items="${currentRegistrations}">
                                            <div class="profile-list-item">
                                                ${r.service != null ? r.service.serviceName :
                                                  (r.gymClass != null && r.gymClass.service != null ?
                                                  r.gymClass.service.serviceName : '---')}
                                            </div>
                                        </c:forEach>
                                    </div>
                                </c:when>
                            ...
                            <c:choose>
                                <c:when test="${not empty currentRegistrations}">
                                    <div class="profile-list-block">
                                        <c:forEach var="r" items="${currentRegistrations}">
                                            <div class="profile-list-item">
                                                <strong>${r.gymClass != null ? r.gymClass.className : '---'}</strong>
                                                <span>
                                                    ${r.status}
                                                    <c:if test="${r.gymClass != null && not empty r.gymClass.trainerName}">
                                                        - ${r.gymClass.trainerName}
                                                    </c:if>
                                                </span>
                                            </div>
                                        </c:forEach>
